...
const ArrowKeys: React.FC = ({}) => {
    ...
    return (
        <div className="grid grid-cols-2 gap-2 mt-2">
            <button 
                className="px-4 sm:px-6 rounded-lg font-mono text-white bg-white-mode-light-blue dark:border-muted-teal dark:bg-blue-500 sm:hover:scale-103 active:scale-95 transform ease-in-out duration-150"
                onClick={()=>handleClear(dispatch)}
            >
                <h1>CLEAR</h1>
            </button>
            <button 
                className="flex justify-center px-4 sm:px-6 rounded-lg font-mono text-white bg-white-mode-light-blue dark:border-muted-teal dark:bg-blue-500 sm:hover:scale-103 active:scale-95 transform ease-in-out duration-150"
