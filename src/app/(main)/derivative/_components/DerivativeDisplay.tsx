...
const DerivativeDisplay: React.FC = () => {
    ...
    return (
    <div className="pt-8 bg-[#00c4eb] text-white dark:bg-gray-800 rounded-lg shadow-lg transition-shadow duration-300 hover:shadow-xl border border-gray-200 dark:border-gray-700 relative z-auto">
...
export default DerivativeDisplay;